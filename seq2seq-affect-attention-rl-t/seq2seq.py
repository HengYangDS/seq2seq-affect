...
parser.add_argument('--model_path', dest='model_path', default='log/run1575272273/009000001080000.model', type=str, help='载入模型位置')  #
...
def comput_loss(outputs, labels, masks):
    ...
    rl_loss = nll_loss+1.2*nll_loss*reward
